    ...
    <> 
        {darkMode ? 
            ...
            <div className="flex gap-5">
                <img src={githubUser?.avatar_url} className=' w-[70px] h-[70px] rounded-full' alt="octacat" />
                <div>
                    <h2 className=' text-[#FFFFFF] font-bold text-base'>{checkOutputValue(githubUser?.name)}</h2>
                    <div className=' text-[#0079FF] font-normal text-[13px]'>{`@${githubUser?.login}`}</div>
                    <div className='text-[#FFFFFF] font-normal text-[13px]'>{transformDataToTime(githubUser?.created_at)}</div>
                </div>
            </div>
            ...
            <div className=' flex flex-col gap-4'>
                ...
                <div className='flex gap-5 cursor-pointer'>
                    ...
                    <div className=' font-normal text-[13px] text-[#FFFFFF]'>{checkOutputValue(githubUser.company)}</div>
                </div>
            </div>
        </div>
        ...
        <div className=" w-[328px] h-[518px] flex flex-col gap-[24px] bg-[#ffffff] p-5 rounded-2xl">
            ...
            <div className="flex gap-5">
                <img src={githubUser?.avatar_url} className=' w-[70px] h-[70px] rounded-full' alt="octacat" />
                <div>
                    <h2 className=' text-[#2B3442] font-bold text-base'>{checkOutputValue(githubUser?.name) }</h2>
                    <div className=' text-[#0079FF] font-normal text-[13px]'>{`@${githubUser?.login}`}</div>
                    <div className='text-[#697C9A] font-normal text-[13px]'>{transformDataToTime(githubUser?.created_at)}</div>
                </div>
            </div>
            ...
            <div className=' flex flex-col gap-4'>
                ...
                <div className='flex gap-5 cursor-pointer'>
                    <img src={Company} alt="company" />
                    <div className=' font-normal text-[13px] text-[#4B6A9B]'>{checkOutputValue(githubUser.company)}</div>
                </div>
            </div>
        </div>
        }
